...
class HorizontalKAIN final : public Accelerator {
public:
    HorizontalKAIN(int max, int min = 0, bool sep = false, std::vector<double> scaling = {})
...
protected:
    ...
    std::deque<OrbitalVector> horizontal_orbitals;  ///< Orbital history
    std::deque<OrbitalVector> horizontal_dOrbitals; ///< Orbital update history
private:
